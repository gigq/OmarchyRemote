...
Browser resumes the last viewed web tab if it is still open on the desktop; otherwise it shows the tab manager. ⌘⇧L opens the manager. ⌘W closes the Hyper window; ⌘⇧W closes the current desktop tab. ⌘/ lists browser shortcuts.
